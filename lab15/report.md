...
В ходе лабораторной работы я приобрела практические навыкы работы с именованными каналами.
