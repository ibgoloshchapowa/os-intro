...
не фоновом, а в привилегированном режиме. Доработала программу так, чтобы
имелась возможность взаимодействия трёх и более процессов.


![Код программы (1)](screen/1.1.png)

*Рис.1 "Код программы (1)"*

![Запуск программы (1)](screen/1.2.png)
...
![Код программы (2)](screen/2.1.png)

*Рис.3 "Код программы (2)"*

![Запуск программы (1)](screen/2.2.png)

*Рис.4 "Запуск программы (1)"*

![Работа программы (2)](screen/2.3.png)
...
![Работа программы (2)](screen/3.1.png)

*Рис.6 "Код программы (3)"*

![Работа программы (2)](screen/3.2.png)
